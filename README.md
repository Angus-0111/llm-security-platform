...
A comprehensive web-based platform for simulating, analyzing, and visualizing attacks on educational LLM tools. This platform helps educators, developers, and students understand LLM security vulnerabilities through interactive demonstrations and real-world case studies.

## 🌟 Live Demo

**🔗 [Try the Live Platform](http://98.87.249.41:3000/)**

Experience the full functionality with real attack simulations and educational content.
...
The platform is currently deployed on AWS EC2 with the following configuration:
...
│   │   │   ├── AttackSimulation/     # Attack simulation UI
│   │   │   ├── Visualization/        # Data visualization
│   │   │   ├── Dashboard/            # Main dashboard
│   │   │   └── NewsIncidentDisplay/  # Incident case viewer
...
- **Issues**: [GitHub Issues](https://github.com/Angus-0111/llm-security-platform/issues)
- **Documentation**: See the `docs/` directory
- **Live Demo**: [http://98.87.249.41:3000/](http://98.87.249.41:3000/)
